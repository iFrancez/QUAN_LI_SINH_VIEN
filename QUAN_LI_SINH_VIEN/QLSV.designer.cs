...
namespace QLSV_TEST2
{
    ...
    partial void OnPháiChanging(string value);
    partial void OnPháiChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Phái", DbType="NChar(10)")]
		public string Phái
		{
			get
			{
			...
			set
			{
				if ((this._Phái != value))
				{
					this.OnPháiChanging(value);
					this.SendPropertyChanging();
					this._Phái = value;
					this.SendPropertyChanged("Phái");
					this.OnPháiChanged();
				}
			}
		}
